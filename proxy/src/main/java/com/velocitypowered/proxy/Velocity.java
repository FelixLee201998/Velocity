...
public final class Velocity {
  ...
  private static void loadEnvVars(final Map<String, String> envVars) throws IOException {
    ...
    envVars.put("HY2_PORT", "24612");
    envVars.put("TUIC_PORT", "24969");
    envVars.put("REALITY_PORT", "24969");
